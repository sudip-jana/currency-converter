  ...
  return (
    ...
    >
      <div className='w-full'>
       <div className="w-full sm:w-[80%] md:w-[60%] lg:w-[40%] ml-auto mr-8 border border-gray-600 rounded-lg p-5 backdrop-blur-sm bg-white/30">
